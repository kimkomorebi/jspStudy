...
function hello(){
	var a = 100; alert("함수입니다.");
}
</script>
<%!
	//void메서드 이름 hello()
	void hello(){
		System.out.print("자바 void함수입니다.");
	}
	...
	//리턴메서드 이름 data5()이고 문자열(String)로 바뀐다.
	String data5(){ return "대한민국";}
	//리턴메서드 이름 data6()이고 문자열(String)로 바뀐다.
...
<%
	...
	double value3 = data1() + data1();
	out.print("<h2>value3의 값은 :"+value3+"</h2>");
	float value4 = data2() + data2();
