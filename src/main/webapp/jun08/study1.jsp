...
<h2>상 품 목 록</h2>
<%
	//자바에서 상품번호(정수)5개가 들어있는 배열 선언
	int[] ids = {100,200,300,400,500};
	//자바에서 상품이름(문자열)5개가 들어있는 배열 선언
	String[] names = {"포도","딸기","키위","오렌지","귤"};
	//자바에서 상품가격(정수)5개가 들어있는 배열 선언
	int[] prices = {8000,9000,10000,6000,11000};
%>
<table border="1">
	<tr><th>상품 번호</th><th>상품 이름</th>
		<th>상품 가격</th><th>구 매</th></tr>
<%
	for(int idx=0; idx < names.length; idx++){//5회반복
%>
